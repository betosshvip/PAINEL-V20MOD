...
<footer class="footer footer-static footer-light">
    <center><p class="clearfix blue-grey lighten-2 mb-0">
        <span class="center">
            ...
            <!-- <a class="text-bold-800 " href="http://www.vip-vps.tk/" target="_blank">VIP-VPS</a><br>TODOS DIREITOS RESERVADOS</span>-->
			<center> © <script>document.write(new Date().getFullYear())</script> | <i class="fa fas-linux"></i> TODOS DIREITOS RESERVADOS</center>
        </span>
