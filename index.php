...
<head>
    ...
    <meta name="keywords" content="VPN SSHLPLUS, VPS, SSH, Gratis, login">
    <meta name="author" content="TWOSSH">
                            ...
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    <div class="card-header pb-1">
                                        ...
                                        <h4><i class="fa fa-linux"></i><b> PAINEL</b></h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="login-footer">
                                        ...
                                        <center><a href="./admin" class="btn btn-outline-danger mr-1 mb-1 waves-effect waves-light"><i class="fa fa-user-circle" aria-hidden="true"></i></a></center>
                                            <div class="card-body">
                                                <p><b> © &copy; <script>document.write(new Date().getFullYear())</script> | Direitos Reservados </b> <i class="fa fa-linux"></i></center>
                                            </div>
                                        </div>
                                    </div>
                                </div>
